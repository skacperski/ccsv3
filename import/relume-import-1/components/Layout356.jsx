              ...
              <div className="container">
                <a href="#" className="flex h-16 w-full items-center underline">
                  <span className="mr-5 font-semibold md:mr-6 md:text-md">
                    Jedna umowa zamiast czterech. Jeden punkt kontaktu dla całej
                    strategii.
                  </span>
                  <h1 className="font-semibold md:text-md">Regulacja</h1>
                </a>
                <div className="py-8 md:py-10 lg:py-12">
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
                      <p className="mb-3 font-semibold md:mb-4">Rozwiązanie</p>
                      <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                        Audyt, polityki, pentesty i SOC. U jednego dostawcy.
                      </h2>
                      <p className="md:text-md">
                        Audyt luk w bezpieczeństwie, polityki dostępu, procedury
                        obsługi incydentów, plan ciągłości biznesu i szkolenia
                        dla zarządu. Wszystko zgodnie z wymogami KSC.
                      </p>
                      <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                        <Button title="Poznaj" variant="secondary">
                          Poznaj
                        </Button>
                        <Button
                          title="→"
            ...
            <div className="px-[5%]">
              <div className="container">
                <a href="#" className="flex h-16 w-full items-center underline">
                  ...
                  <h1 className="font-semibold md:text-md">Technologia</h1>
                </a>
                <div className="py-8 md:py-10 lg:py-12">
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
            ...
            <div className="px-[5%]">
              <div className="container">
                <a href="#" className="flex h-16 w-full items-center underline">
                  ...
                  <h1 className="font-semibold md:text-md">Ciągłość</h1>
                </a>
                <div className="py-8 md:py-10 lg:py-12">
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
