    ...
    >
      <div className="mx-[5%] max-w-[40rem] justify-self-start lg:ml-[5vw] lg:mr-20 lg:justify-self-end">
        <h1 className="mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-10xl">
          NIS2 w Polsce: audyt, wdrożenie i bezpieczeństwo techniczne
        </h1>
        <p className="md:text-md">
          Krajowa Strategia Cyberbezpieczeństwa obowiązuje od lutego 2026.
          CyCommSec przeprowadzi audyt, wdroży polityki, przeprowadzi pentesty i
          utrzyma twoje systemy w zgodności 24/7. Wszystko w jednej umowie.
        </p>
        <div className="mt-6 flex flex-wrap gap-4 md:mt-8">
          <Button title="Zacznij od ankiety">Zacznij od ankiety</Button>
