      ...
      <div className="container">
        <div className="rb-12 mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            <FuseKicker num="06" className="mb-3 text-fuse-blue md:mb-4">
              {how.kicker}
            </FuseKicker>
        ...
        <div className="grid grid-cols-1 gap-6 md:gap-8">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:gap-8 lg:grid-cols-4">
            <div className="grid grid-cols-1 bg-fuse-blue sm:col-span-2 sm:row-span-1">
              <div className="flex flex-1 flex-col justify-center p-6 md:p-8 lg:p-12">
                <div>
                  <p className="mb-2 font-mono text-sm font-medium text-white/60">001 /</p>
                  <p className="mb-4 font-mono text-xs font-medium uppercase tracking-[0.08em] text-white/60">
                    Zacznij tutaj
                  </p>
                  <h3 className="mb-5 text-4xl font-medium leading-[1.2] text-white md:mb-6 md:text-5xl lg:text-6xl">
                    {how.steps[0].title}
                  </h3>
            ...
            {how.steps.slice(1).map((item, i) => (
              <div
                key={i}
                className="flex h-full flex-col border border-fuse-line bg-white"
              >
                <div className="flex flex-1 flex-col p-6 md:p-8 lg:p-6">
                  <p className="mb-3 font-mono text-sm font-medium text-fuse-blue">
