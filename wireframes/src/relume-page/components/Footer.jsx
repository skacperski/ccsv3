  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="min-w-0">
        <p className="text-sm font-semibold leading-tight text-vent-carbon">{person.name}</p>
        <p className="mt-0.5 text-xs uppercase tracking-wide text-vent-slate">{person.role}</p>
        <div className="mt-1 flex flex-col gap-0.5 text-xs">
          <a
            href={person.phoneHref}
            data-track="contact_phone"
            data-track-location="stopka"
            className="text-vent-graphite hover:text-vent-carbon"
          ...
          <a
            ...
            data-track-location="stopka"
            className="truncate text-vent-graphite hover:text-vent-carbon"
        ...
        <CalendarCtaButton
          ...
          className="mt-2 text-xs font-medium uppercase tracking-widest !text-vent-carbon underline-offset-4 hover:underline"
        >
          ↗ Umów spotkanie
        </CalendarCtaButton>
      </div>
...
export function Footer({ footer }) {
  return (
    <footer id="kontakt" className="border-t border-vent-chalk bg-vent-mist">
      <div className="px-[5%] py-12 md:py-16">
        <div className="container grid grid-cols-1 gap-12 md:grid-cols-2 lg:gap-20">
          ...
          <div className="flex flex-col gap-4 text-xs leading-relaxed text-vent-slate">
            {LEGAL.map((text, i) => (
              <p key={i}>{text}</p>
            ))}
          </div>
      ...
      <div className="border-t border-vent-chalk px-[5%] py-6">
        <div className="container flex flex-col items-center justify-between gap-4 text-sm sm:flex-row">
          <p className="font-display text-vent-carbon">{footer.brand}</p>
          <div className="flex items-center gap-6 text-xs text-vent-graphite">
            <a href="#" className="underline hover:text-vent-carbon">
              {footer.privacy}
            </a>
