...
channel: Google Ads
campaign: nis2-kary
utm: "?utm_source=google&utm_medium=cpc&utm_campaign=nis2-kary&utm_content=kary-zarzad"
scopeMode: full
hideCompare: true
featuredCard: card-audit
ctaUnified: Sprawdź ryzyko w 2 min
secondaryCta: "Wolisz rozmowę? Pokaż kalendarz"
persona: personas/gads-kary.md
---

# Copy — `gads-kary` (Google Ads · regulacyjny, intencja: kary KSC)
